          ...
          >
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
                Smart Water
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-600"> Level Detection</span>
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed">
                Advanced ultrasonic sensor technology for precise water tank monitoring. 
                Real-time level detection with unmatched accuracy and reliability.
              </p>
            </motion.div>
            ...
            <motion.div 
              ...
              variants={staggerContainer}
            >
              <motion.div className="text-center" variants={mobileAnimationVariants}>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-teal-600/80 flex items-center justify-center">
                    <div className="text-center text-white">
                      ...
                      <p className="text-blue-100 text-sm">Ultrasonic Excellence</p>
                    </div>
                  </div>
                </div>
              </div>
